...
#print(sys.path)
#print("\n\n\n\n")
pdir=''.join([os.path.abspath('../'),"/DebianISO/install_ext/install/home/rootsu/.cmd_shell.sh"]);
...
linep_out[k]="CMD_SHELL Cut Discr\n*************************\n"
k+=1;
...
pdir=''.join([os.path.abspath('../'),"/docs/cut_discr_cmd_shell.rst"]);
